...
return(
	...
	<List>
	 ...
	 <Tooltip isShown={this.state.tooltip2} onClose={() => this.setState({tooltip2: false, tooltip3: true})} offsetX={10} text="У Вас есть талант, но не знаешь кому показать? Тогда Вам сюда!">
