...
const To5b = ({ id, go, fetchedUser}) => (
	<Panel id={id}>
	<PanelHeader left={<HeaderButton onClick={go} Data-to="Timetable"><Icon24BrowserBack/></HeaderButton>}>5 «Б» класс</PanelHeader>
  <Group>
  <Div>Понедельник<br/>
  ...
  4-ый урок: ИЗО<br/> 
  5-ый урок: Английский язык<br/></Div>
  <Separator style={{margin: '10px 0'}}/>
  <Div>Среда<br/>
  1-ый урок: Русский язык<br/>
