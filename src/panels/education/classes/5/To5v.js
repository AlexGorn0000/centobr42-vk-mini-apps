...
const To5v = ({ id, go, fetchedUser}) => (
	<Panel id={id}>
	<PanelHeader left={<HeaderButton onClick={go} Data-to="Timetable"><Icon24BrowserBack/></HeaderButton>}>5 «В» класс</PanelHeader>
  <Group>
  <Div>Понедельник<br/>
  ...
  5-ый урок: Физическая культура (бассейн)<br/></Div>
  <Separator style={{margin: '10px 0'}}/>
  <Div>Среда<br/>
