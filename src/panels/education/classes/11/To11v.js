...
const To11v = ({ id, go, fetchedUser}) => (
	<Panel id={id}>
	<PanelHeader left={<HeaderButton onClick={go} Data-to="Timetable"><Icon24BrowserBack/></HeaderButton>}>11 «В» класс</PanelHeader>
  <Group>
  <Div>Понедельник<br/>
  ...
  3-ий урок: Электронная математика<br/> 
  4-ый урок: ОБЖ<br/> 
