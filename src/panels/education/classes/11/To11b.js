...
const To11b = ({ id, go, fetchedUser}) => (
	<Panel id={id}>
	<PanelHeader left={<HeaderButton onClick={go} Data-to="Timetable"><Icon24BrowserBack/></HeaderButton>}>11 «Б» класс</PanelHeader>
  <Group>
  <Div>Понедельник<br/>
  ...
  5-ый урок: Электронноя химия<br/>
  6-ой урок: Математика<br/>
  7-ой урок: Русский язык<br/>
  8-ой урок: Химия</Div>
  <Separator style={{margin: '10px 0'}}/>
  <Div>Среда<br/>
  ...
  7-ой урок: Физика<br/>
  8-ой урок: Английский язык</Div>
  <Separator style={{margin: '10px 0'}}/>
  <Div>Четверг<br/>
  1-ый урок: Нет урока<br/>
  2-ый урок: Английский язык<br/> 
  3-ий урок: Литература<br/> 
  4-ый урок: Родной язык<br/> 
  5-ый урок: Биология<br/>
  6-ой урок: Биология<br/>
  7-ой урок: Физическая культура (зал)<br/>
  8-ой урок: Физика</Div>
  <Separator style={{margin: '10px 0'}}/>
  <Div>Пятница<br/>
  1-ый урок: Информатика (1-я гр)/Биология<br/>
  2-ой урок: История<br/> 
  3-ий урок: Биология<br/> 
  4-ый урок: Обществознание<br/> 
  5-ый урок: Информатика (2-я гр)/Биология<br/>
  6-ой урок: Литература<br/>
  7-ой урок: Обществознание</Div>
  <Separator style={{margin: '15px 0'}}/>
  <Cell before={<Icon24ShareOutline/>} onClick={connect.subscribe("VKWebAppShare", {"link": "https://vk.com/app7266393_-187421428"})}>Поделиться</Cell>
  </Group>
 </Panel>
);
