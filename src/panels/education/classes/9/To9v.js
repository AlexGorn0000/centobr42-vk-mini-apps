...
const To9v = ({ id, go, fetchedUser}) => (
	<Panel id={id}>
	<PanelHeader left={<HeaderButton onClick={go} Data-to="Timetable"><Icon24BrowserBack/></HeaderButton>}>9 «В» класс</PanelHeader>
  <Group>
  <Div>Понедельник<br/>
