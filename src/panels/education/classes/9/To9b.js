...
const To9b = ({ id, go, fetchedUser}) => (
	<Panel id={id}>
	<PanelHeader left={<HeaderButton onClick={go} Data-to="Timetable"><Icon24BrowserBack/></HeaderButton>}>9 «Б» класс</PanelHeader>
  <Group>
  <Div>Понедельник<br/>
  ...
  7-ой урок: Родная литература</Div>
