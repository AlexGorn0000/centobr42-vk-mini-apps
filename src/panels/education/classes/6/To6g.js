...
const To6g = ({ id, go, fetchedUser}) => (
	<Panel id={id}>
	<PanelHeader left={<HeaderButton onClick={go} Data-to="Timetable"><Icon24BrowserBack/></HeaderButton>}>6 «Г» класс</PanelHeader>
  <Group>
  <Div>Понедельник<br/>
  ...
  7-ой урок: Физическая культура (бассейн)</Div>
